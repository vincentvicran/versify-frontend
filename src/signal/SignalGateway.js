...
export class SignalServerStore {
    ...
    registerNewPreKeyBundle(userId, preKeyBundle) {
        ...
        storageBundle.preKey.publicKey = util.arrayBufferToBase64(
            storageBundle.preKey.publicKey
        );
    ...
    getPreKeyBundle(userId) {
        ...
        storageBundle.identityKey = util.base64ToArrayBuffer(
            storageBundle.identityKey
        );
        storageBundle.preKey.publicKey = util.base64ToArrayBuffer(
            storageBundle.preKey.publicKey
        );
...
class SignalProtocolManager {
    ...
    async initializeAsync() {
        ...
        this.signalServerStore.registerNewPreKeyBundle(
            this.userId,
            preKeyBundle
        );
    }
